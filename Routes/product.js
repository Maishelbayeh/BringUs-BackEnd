 ...
 *     description: Add a new review to a product (supports both authenticated users and guests)
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *               guestId:
 *                 type: string
 *                 description: Guest ID (required for guest users)
 *               guestName:
 *                 type: string
 *                 description: Guest name (required for guest users)
 *               guestEmail:
 *                 type: string
 *                 format: email
 *                 description: Guest email (required for guest users)
 *     responses:
 *       201:
 ...
 */
router.put('/:productId/reviews', ProductController.updateReview);
 ...
 *         description: Product or review not found
 */
router.delete('/:productId/reviews', ProductController.deleteReview);
...
/**
 * @swagger
 * /api/products/{productId}/reviews/{reviewId}/verify:
 *   patch:
 *     summary: Verify review (Admin only)
 *     description: Toggle verification status of a review
 *     tags: [Products]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Review verification status updated successfully
 *       400:
 *         description: Bad request
 *       404:
 *         description: Product or review not found
 */
router.patch('/:productId/reviews/:reviewId/verify', protect, ProductController.verifyReview);
