/**
 * Create Delivery and Payment Data Script (Atlas Version)
 * 
 * This script creates test data for delivery and payment methods
 * for two sample stores: TechStore and FashionStore.
 * Uses MongoDB Atlas connection.
 * 
 * Usage:
 *   node scripts/createDeliveryPaymentDataAtlas.js
 * 
 * Features:
 * - Creates delivery methods for different locations
 * - Creates payment methods with various types
